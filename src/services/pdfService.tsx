  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>🧠 ReflectMe</Text>
      ...
      {/* Recommendations */}
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>💡 Raccomandazioni Cliniche</Text>
      ...
      <Text style={styles.footer}>
        This report was automatically generated by the ReflectMe system.
        {'\n'}For information: support@reflectme.app
      </Text>
    </Page>
  </Document>
);
...
const createPDFBuffer = async (reportData: ReportData): Promise<Buffer> => {
  try {
    ...
    const reportContent = `
ReflectMe - Report Andamento Sintomi
===================================
...
NOTE:
Questo report è stato generato automaticamente dal sistema ReflectMe.
Per interpretazioni cliniche dettagliate, consultare il terapista di riferimento.

---
ReflectMe Clinical Assessment System
